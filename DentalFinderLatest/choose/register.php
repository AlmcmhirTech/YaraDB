...
<body>
    ...
    <section class="my-5 py5">
        ...
        <div class="mx-auto container text-center">
            ...
            <div class="btn-group">
                <a href="../clinic/register/clinic_register.php" class="btn btn-primary mx-2">Dental Clinic</a>
                <a href="../user/register/patient_register.php" class="btn btn-primary mx-2">Patient</a>
            </div>
        </div>
    </section>
