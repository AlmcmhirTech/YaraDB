                                ...
                                <div class="modal-body">
                                    ...
                                    <form method = 'post' action ='branches.php'>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="bName" name = "clinic_address">
                                        </div>
                                        <div class="mb-3">
                                            <label for="bCode" class="form-label">License Code:</label>
                                            <input type="text" class="form-control" id="bCode" name = "license_code">
                                        </div>

                                        <div class="mb-3">
                                            <label for="bNum" class="form-label">Contact</label>
                                            <input type="tel" class="form-control" id="bNum" name = "mobile_number">
                                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    $branches = $clinicObj->showBranches($clinic_id);

                                    foreach($branches as $arr){
                                        ?>
                                    
                                    <td><?= $arr['branch_id']?></td>
                                    <td><?= $arr['branch_address']?></td>
