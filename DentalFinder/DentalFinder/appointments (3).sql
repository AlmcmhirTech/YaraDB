...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2024 at 02:36 PM
...
--
ALTER TABLE `appointments`
  MODIFY `appointment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
ALTER TABLE `appointments`
  ...
  ADD CONSTRAINT `appointments_ibfk_4` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`branch_id`);
COMMIT;
