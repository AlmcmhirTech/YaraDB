    ...
    if(isset($_POST["login"])){
        ...
        if ($verify) {
            if (password_verify($addClinic->password, $verify['password'])) {
                ...
                $_SESSION['booking_clinic_id'] = $verify['clinic_id'];
...
<head>
    ...
    <link rel="stylesheet" href="../../css/clinic_login.css">
</head>
<body>
 ...
 <section class="my-5 py5">
    ...
    <div class="mx-auto container">
        <form id="login-form">
            ...
            <div class="form-group">
               <p>Don't have an account?<a id="register-url" class="btn">Register</a></p>
            </div>
        </form>
    </div>
 </section>
