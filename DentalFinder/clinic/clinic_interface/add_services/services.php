                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="mt-2">
                                        <label for="minPrice" class="form-label">Minimum Price (PHP):</label>
                                        <input type="number" class="form-control" id="minPrice" placeholder="Enter minimum price">
                                    </div>
                                    <div class="mt-2">
                                        <label for="maxPrice" class="form-label">Maximum Price (PHP):</label>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Orthodontics</td>
                                    <td>PHP 5,000 – PHP 20,000</td>
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editClinicModal">
                                            Edit
                                        </button>
